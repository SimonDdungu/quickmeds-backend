...
class Medicine(models.Model):
    ...
    generic_name = models.CharField(max_length=100, blank=True, null=True)     #Like Flavor or Type, Different Panadols include Panadol Extra, Paracetamol, Cold and Flu
    dosage_form = models.CharField(max_length=20, choices=DOSAGE_FORMS, blank=True, null=True)         #Tablet
